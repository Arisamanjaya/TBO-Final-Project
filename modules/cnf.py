...
def get_set_of_production(): # fungsi untuk mengambil set produksi
    ...
    f = open("/Users/arisamanjaya/Documents/KULIAH BROW/SEMESTER 3 YUK SERIUS/Teori Bahasa dan Otomata/TBO Final Project/modules/raw.txt", "r", encoding="utf-8") # membuka file variable_list.txt
    for lines in f: # perulangan untuk setiap baris pada file
        ...
        if lhs in RESULT.keys(): # jika key sudah ada di dictionary
